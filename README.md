...
> A curated list of tools, cameras, tutorials, techniques, regulations, filters, workflows, apps, and resources for **drone photography and cinematography** — from flight techniques to professional post-production pipelines.

## Contents

- [Official Resources](#official-resources)
- [Drones & Camera Systems](#drones--camera-systems)
- [Filters, Lenses & Accessories](#filters-lenses--accessories)
- [Flight Techniques & Cinematic Skills](#flight-techniques--cinematic-skills)
- [Aerial Photography Techniques](#aerial-photography-techniques)
- [Cinematic Shooting Modes](#cinematic-shooting-modes)
- [Software for Editing & Post-Production](#software-for-editing--post-production)
- [Mapping, Surveying & 3D Modeling](#mapping-surveying--3d-modeling)
- [Legal, Safety & Regulations](#legal-safety--regulations)
...
- [Sunhoods, Landing Pads, Range Extenders](https://www.dji.com/)

## Flight Techniques & Cinematic Skills

- **Reveal Shot** – Fly upward or sideways to gradually reveal landscape details.
- **Orbit (Point of Interest)** – Circle around a subject for cinematic dynamism.
- **Dolly-In/Dolly-Out** – Move forward/backward while adjusting gimbal tilt.
- **Parallax Shots** – Foreground elements move faster than background.
- **Top-Down (“Nadir”) Shots** – Iconic mapping-style overhead imagery.
- **Hyperlapse / Timelapse Aerials** – Smooth long-time-motion sequences.

## Aerial Photography Techniques

- **Golden Hour & Blue Hour Timing** – Best natural lighting.
- **HDR Exposure Bracketing** – Balanced exposure in complex scenes.
- **Panorama Modes**
  - Sphere
  - 180°
  - Vertical
  - Wide
- **Focus Peaking & Manual Focus** – For cinema drones with adjustable lenses.
- **RAW Shooting** – Maximizes post-production flexibility.

## Cinematic Shooting Modes

- **D-Log / D-Log M / HLG** – Flat profiles for professional color grading.
- **Cine Mode** – Smooth, slow, cinematic movement.
- **ActiveTrack** – Subject tracking with cinematic parameters.
- **Waypoint Missions** – Automated repeatable flight paths.
- **Cruise Control** – Smooth long-distance flight paths.

## Software for Editing & Post-Production
...
- **Canada (Transport Canada)**  
  - Basic & Advanced RPAS certifications  
  - Flight restrictions & no-fly zones

- **United States (FAA Part 107)**
- **Europe (EASA Open/A1–A3, Specific, Certified Categories)**
...
- [Drone Film Guide (YouTube)](https://www.youtube.com/c/DroneFilmGuide)
- [Jeven Dovey](https://www.youtube.com/c/jevendovey)
- [Peter McKinnon](https://www.youtube.com/user/petermckinnon24)

### **Books**
- *The Drone Photography Handbook*
- *Mastering Aerial Photography*

### **Communities**
- [r/drones](https://www.reddit.com/r/drones/)
- [DJI Forums](https://forum.dji.com/)
